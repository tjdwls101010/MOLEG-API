...
- PR #89 deterministic GitHub Actions CI passed after #91: recorded run `27641400110` ran non-live tests on Python 3.10, 3.11, and 3.12 plus a package wheel/install gate with Node 24 opt-in.
