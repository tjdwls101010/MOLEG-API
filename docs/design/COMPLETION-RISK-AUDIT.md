...
Initial core risk audited on 2026-06-15 after the legislative live e2e gate and annex/form body loading were added. Current integration-branch evidence was refreshed on 2026-06-17 after the consumer-readiness gate work and follow-up contract guards.
...
- Deterministic non-live tests passed on the integration branch: `130 passed, 54 deselected`.
