...
Current readiness evidence is tracked in `docs/design/GOAL-COMPLETION-AUDIT.md`; the live legislative scenario gate is documented in `docs/design/LIVE-E2E-SCENARIOS.md`; deterministic answer-readiness scenarios are documented in `docs/design/LEGISLATIVE-EXPERT-E2E-AUDIT.md`; residual risks are tracked in `docs/design/COMPLETION-RISK-AUDIT.md`. The 2026-06-16 review of fitness as a tool for the consuming skill is in `docs/design/CONSUMER-READINESS-REVIEW.md`; its roadmap was merged through PR #89.
